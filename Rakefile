  ...
  Releasy::Project.new do
    ...
    add_link "http://terciar.info", "Terciar Web site"
    ...
    add_build :windows_wrapped do
      wrapper "vendors/ruby-1.9.3-p0-i386-mingw32.7z" # Assuming this is where you downloaded this file.
      executable_type :windows # Assuming you don't want it to run with a console window.
